...
<div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-md-4">Stok Tersedia (1,2,3,4,5)</label>
            <div class="col-md-1">
                <input name="s" class="form-control" type="text" value="<?php echo $data->s1; ?>" readonly="readonly">
            </div>
            <div class="col-md-1">
                <input name="m" class="form-control" type="text" value="<?php echo $data->m2; ?>" readonly="readonly">
            </div>
            <div class="col-md-1">
                <input name="l" class="form-control" type="text" value="<?php echo $data->l3; ?>" readonly="readonly">
            </div>
            <div class="col-md-1">
                <input name="xl" class="form-control" type="text" value="<?php echo $data->xl4; ?>" readonly="readonly">
            </div>
            <div class="col-md-1">
                <input name="as" class="form-control" type="text" value="<?php echo $data->as5; ?>" readonly="readonly">
            </div>
        </div>

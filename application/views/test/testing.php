...
$this->fpdf->Ln(1); $this->fpdf->SetFont('Times','B',12); 
$this->fpdf->Cell(19,1,'Header',0,0,'C'); /* setting header table */ 
$this->fpdf->Ln(1); 
$this->fpdf->SetFont('Times','B',12); 
$this->fpdf->Cell(6 , 1, 'ID Penjualan' , 1, 'LR', 'L'); 
$this->fpdf->Cell(5 , 1, 'NAMA_CUST' , 1, 'LR', 'L'); 
...
foreach($hasil as $data) { 
	...
	$this->fpdf->Cell(5 , 0.7, $data->longi , 1, 'LR', 'L'); //$this->fpdf->Cell(10 , 0.7, $data->alamat , 1, 'LR', 'L'); 
